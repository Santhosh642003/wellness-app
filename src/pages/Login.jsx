                ...
                <form onSubmit={handleRegister} className="space-y-5">
                  <div>
                    ...
                    <input
                      ...
                      maxLength={6}
                      inputMode="numeric"
                      className="w-full rounded-xl bg-slate-50 dark:bg-[#0f0f0f] border border-slate-200 dark:border-gray-800 px-4 py-4 text-slate-900 dark:text-gray-100 text-center text-2xl font-mono tracking-[0.5em] focus:outline-none focus:ring-2 focus:ring-blue-500/40"
                    />
                  </div>
                  {error && <p className="text-sm text-red-400 bg-red-900/20 border border-red-800/40 rounded-xl px-4 py-3">{error}</p>}
